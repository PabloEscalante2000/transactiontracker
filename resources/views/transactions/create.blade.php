<x-layout title="Nueva Transaccion">
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Nueva transaccion</h1>
            <p class="text-sm text-gray-500 mt-0.5">Registra un ingreso o gasto</p>
        </div>
    </div>

    <form action="/transactions/create" method="POST" class="max-w-2xl space-y-6">
        @csrf
